...
import {
  Ecommerce, Statistik, DownloadCSV, SemuaDataAlat, DaftarAlat, DataUser, DataDamkar, FormDaftarAlat, Orders, Calendar, Employees, Customers,
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<PrivateRoute><MainLayout /></PrivateRoute>}>
            ...
            <Route path="data-damkar" element={<DataDamkar />} />
            <Route path="form-daftar-alat" element={<FormDaftarAlat />} />
